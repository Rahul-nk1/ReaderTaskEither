...
import { LocalStorage, LocalStorageEnv } from "./service/localStorage/LocalStorage"
import {
  CacheService,
  CacheServiceEnv,
...
export const cacheService: CacheService = makeLocalStorageCacheService(localStorageEnv)
